...
@AllArgsConstructor
@Slf4j
public class Org2FabricGatewayConfig {

    private HyperLedgerFabricProperties hyperLedgerFabricProperties;

    @Bean(name = "Org2Gateway")
    public Gateway gateway() throws Exception {
        hyperLedgerFabricProperties.setMspId("Org2MSP");
        hyperLedgerFabricProperties.setNetworkConnectionConfigPath("src/main/resources/org2ProdNetworkConnection.json");
        hyperLedgerFabricProperties.setCertificatePath("src/main/resources/crypto-config/prod-network/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp/signcerts/User1@org2.example.com-cert.pem");
        hyperLedgerFabricProperties.setPrivateKeyPath("src/main/resources/crypto-config/prod-network/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp/keystore/priv_sk");
        hyperLedgerFabricProperties.setTlsCertPath("src/main/resources/crypto-config/prod-network/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt");
    ...
    private ManagedChannel newGrpcConnection() throws IOException, CertificateException {
        ...
        return NettyChannelBuilder.forTarget("120.46.223.77:9051")
...
//        //获取通道
//        return Org2Gateway.getNetwork(hyperLedgerFabricProperties.getChannel());
//    }
//
//    @Bean(name = "Org2Contract")
//    public Contract contract() {
//        //获取合约
//        return Org2Network.getContract("hyperledger-fabric-contract-java-demo" , "CatContract");
//    }

    @Bean(name = "Org2ChaincodeEventListener")
